...
const testAddresses = {
  VIC: { formattedAddress: '1 Clara Street, South Yarra VIC 3141', state: 'VIC' },
...
async function testVicInit() {
  const preferences = {
    get: () => ({
      ...
      workAddress: { formattedAddress: '80 Collins St, Melbourne VIC 3000' },
      cafeLocation: { formattedAddress: 'Norman Cafe, South Yarra VIC' },
      arrivalTime: '09:00',
      coffeeEnabled: true
    })
  };
