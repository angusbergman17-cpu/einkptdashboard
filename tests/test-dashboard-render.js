...
const mockPreferences = {
  get: () => ({
    // Locations
    homeAddress: { lat: -37.8428, lon: 144.9920, formattedAddress: 'Clara St, South Yarra' },
    homeLocation: { lat: -37.8428, lon: 144.9920, formattedAddress: 'Clara St, South Yarra' },
    cafeLocation: { lat: -37.8406, lon: 144.9920, formattedAddress: 'Norman Cafe' },
    coffeeAddress: { lat: -37.8406, lon: 144.9920, formattedAddress: 'Norman Cafe' },
    workAddress: { lat: -37.8136, lon: 144.9645, formattedAddress: '80 Collins St' },
    workLocation: { lat: -37.8136, lon: 144.9645, formattedAddress: '80 Collins St' },
