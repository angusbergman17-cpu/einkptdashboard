...
// ---------------------------------------------------------------------------
// SCENARIO: Angus Default - Home → Coffee → Tram → Train → Office
// ---------------------------------------------------------------------------
scenarios['angus-default'] = {
  origin: '1 CLARA ST, SOUTH YARRA',
  destination: '80 COLLINS ST, MELBOURNE',
  currentTime: '8:15',
  ampm: 'AM',
  ...
  leaveInMinutes: 3,
  isHomebound: false,
  weather: { temp: 22, condition: 'Clear', umbrella: false },
  coffeeStop: {
  ...
  steps: [
    {
      type: StepType.WALK,
      title: 'Walk to Norman South Yarra',
      subtitle: 'From home • 3 min',
      duration: 3,
      status: StepStatus.NORMAL
    },
    {
    ...
    },
    {
      type: StepType.TRAM,
      title: 'Tram 78 to Richmond',
      subtitle: 'Chapel St • Next: 2, 10 min',
      duration: 8,
      status: StepStatus.NORMAL
    },
    {
      type: StepType.WALK,
      title: 'Walk to Richmond Station',
      subtitle: 'Swan St interchange',
      duration: 3,
      status: StepStatus.NORMAL
    },
    {
      type: StepType.TRAIN,
      title: 'Train to Parliament',
      subtitle: 'South Morang Line • Next: 3, 8 min',
      duration: 6,
      status: StepStatus.NORMAL
    },
    {
...
// ---------------------------------------------------------------------------
// SCENARIO: Tram + Train Multi-Modal (Generic)
// ---------------------------------------------------------------------------
scenarios['tram-train-multimodal'] = {
  origin: 'HOME',
  destination: 'WORK',
  currentTime: '8:00',
  ampm: 'AM',
  ...
  steps: [
    ...
    {
      type: StepType.TRAM,
      title: 'Tram to Interchange',
      subtitle: 'Route varies by config',
      duration: 12,
      status: StepStatus.NORMAL
    },
    {
    ...
    },
    {
      ...
      subtitle: 'Line varies by config',
      duration: 15,
      status: StepStatus.NORMAL
    },
    {
