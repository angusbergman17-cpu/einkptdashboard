...
export default scenarios;
  ...
  // ---------------------------------------------------------------------------
  // SCENARIO: Random Melbourne Journey
  // ---------------------------------------------------------------------------
  'random': {
    origin: '42 BRUNSWICK ST, FITZROY',
    destination: '200 BOURKE ST, MELBOURNE',
    currentTime: '8:15',
    ampm: 'AM',
    dayOfWeek: 'Wednesday',
    date: '29 January',
    ...
    totalDuration: 43,
    isHomebound: false,
    weather: { temp: 24, condition: 'Partly Cloudy', umbrella: false },
    steps: [
      {
        type: StepType.WALK,
        title: 'Walk to Industry Beans',
        subtitle: 'From home • 3/62 Rose St',
        duration: 6,
        status: StepStatus.NORMAL
      },
      {
        type: StepType.COFFEE,
        title: 'Coffee at Industry Beans',
        subtitle: '✓ TIME FOR COFFEE',
        duration: 5,
        status: StepStatus.NORMAL
      },
      {
        type: StepType.WALK,
        title: 'Walk to Tram Stop',
        subtitle: 'Smith St / Johnston St',
        duration: 4,
        status: StepStatus.NORMAL
      },
      {
        type: StepType.TRAM,
        title: 'Tram 86 to Bourke St',
        subtitle: 'City bound • Next: 3, 8 min',
        duration: 18,
        status: StepStatus.NORMAL
      },
      {
        type: StepType.WALK,
        title: 'Walk to Office',
        subtitle: 'Bourke St → 200 Bourke St',
        duration: 5,
        status: StepStatus.NORMAL
      }
    ]
